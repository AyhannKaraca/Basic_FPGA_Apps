...
# Switches
set_property PACKAGE_PIN V17 [get_ports {a_i}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {a_i}]
set_property PACKAGE_PIN V16 [get_ports {b_i}]					
...
# LEDs
set_property PACKAGE_PIN U16 [get_ports {c_o}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {c_o}]
